...
Как мы узнали, всё общение между компьютерами — это запросы. Вот ты пришёл на "корневой путь" — например, https://dkzlv.com/ — и это один запрос. А если хочешь перейти на страницу конкретной записи — например, [https://dkzlv.com/*#ru/privacy-fuckup*](https://dkzlv.com/ru/privacy-fuckup) — это уже второй, свой, отдельный запрос.
