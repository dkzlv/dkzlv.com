...
Список можно продолжать до бесконечности. Я сейчас делаю базу сливов: все истории, когда данные утекали из корпораций или государств, разбитые по категориям, странам, с количеством пострадавших и короткой подводкой, как и что происходило. Если интересно — подписывайтесь, оно уже вот-вот в релиз уйдёт.
...
<div class='enum'>
  ...
  **каким кекесом вы занимаетесь**
  ...
  3fun [просрали все данные 1.5М юзеров](https://techcrunch.com/2019/08/08/group-dating-app-3fun-security-flaws/): адреса, телефоны, почты, геолокацию и пр.
